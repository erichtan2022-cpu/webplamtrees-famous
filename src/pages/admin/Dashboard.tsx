...
export default function AdminDashboard() {
  ...
  const managementLinks = [
    ...
    { to: '/admin/pages', label: 'Edit Teks Halaman', icon: LayoutTemplate, desc: 'Perbarui judul & deskripsi semua halaman' },
    { to: '/admin/images', label: 'Kelola Gambar', icon: ImageIcon, desc: 'Ganti, tambah, atau hapus gambar website' },
    ...
    { to: '/admin/programs', label: 'Program', icon: BookOpen, desc: 'Edit detail program sekolah' },
